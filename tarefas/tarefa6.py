"""
TAREFA 6 - Energia Eolica (Aula 03) -- VERSAO CORRIGIDA
Curvas de Weibull para Fortaleza/CE, em dois anos (2019 e 2024), considerando
...
graficos individuais. Somado aos 6 graficos gerados por tarefa5.py
(Picos), totalizam-se os 12 graficos pedidos.
...
mesma coluna usada na Tarefa 6, para consistencia entre localidades.

Saidas (salvas em ../resultados/tarefa6/):
    weibull_fortaleza_2019_k1.0.png
    weibull_fortaleza_2019_k2.0.png
    weibull_fortaleza_2019_k3.5.png
    weibull_fortaleza_2024_k1.0.png
    weibull_fortaleza_2024_k2.0.png
    weibull_fortaleza_2024_k3.5.png
...
for ano in ANOS:
    ...
    for k in VALORES_K:
        ...
        nome_arquivo = f"weibull_fortaleza_{ano}_k{k}.png"
